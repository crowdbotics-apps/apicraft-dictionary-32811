...
## Project Structure
    ...
    ├── apicraft_dictionary_32811  # Django project configurations
...
1. Clone this repo and `cd apicraft_dictionary_32811`
...
2. Clone this repo and `cd apicraft_dictionary_32811`
